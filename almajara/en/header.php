...
<header class="breadcrumb-hide">
    ...
    <div id="top-bar" class="container-fluid position-fixed opacity-top" style="width: 100%; z-index: 9999; position: fixed;">
        <div class="row">
            <div class="col-md-12 col-xs-12 text-right">
                <p><span class="padding-right-5 lets-talk">Let's Talk:</span><span class="tel-icon">
    ...
    <ul id="lang-nav">
        <li><a href="javascript:void(0)" class="background-tranparent"><span id="language-code"></span><img src="https://www.chetu.com/img/icons/down-arrow.png" alt="language Change Indication Arrow" class="margin-left-10" style="width: 10px;" /></a>
            <ul>
    ...
    <script>
        ...
        document.getElementById("lang-nav").addEventListener("click", function(e) {
            ...
            if (clicked == "ar") {
                if (isLang == -1) {
                    newPath = window.location.origin + "/almajara/ar";
    ...
    <nav class="navbar mega-menu navbar-default navbar-default-transparent navbar-fixed-top white-nav">
        ...
        <div class="navbar-header">
                <div data-toggle="collapse" data-target="#chetu-nav" class="navbar-toggle navbar-toggle-button cd-header-buttons">
                    <div id="bar"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span>
                </div>
                </div>
            ...
            <div id="chetu-nav" class="navbar-collapse collapse">
                ...
                <li class="on-demand-develop padding-right-15"><a href="home.php" class="dropdown-toggle-hover">HOME</a></li>
                <li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle dropdown-toggle-hover arrow-sec arrow-down arrow-down arrow-down">Solutions</a>
                        <ul role="menu" class="dropdown-menu dropdown-single">
                            <li><a href="animationgraphicdesign.php" class="remove-dropdown-icon">Animation & Graphic Design</a></li>
                            <li><a href="cms.php" class="remove-dropdown-icon">CMS</a></li>
                            <li><a href="crm.php" class="remove-dropdown-icon">CRM</a></li>
                            <li><a href="digitalmarketing.php" class="remove-dropdown-icon">Digital Marketing</a></li>
                            <li><a href="sap.php" class="remove-dropdown-icon">SAP</a></li>
                            <li><a href="uiux.php" class="remove-dropdown-icon">UI / UX</a></li>
                            <li><a href="webdevelopment.php" class="remove-dropdown-icon">Web Development</a></li>
                        </ul>
                    </li>
                <li class="on-demand-develop padding-right-15"><a href="clients.php" class="dropdown-toggle-hover">Our Clients</a></li>
                <li class="on-demand-develop padding-right-15"><a href="work.php" class="dropdown-toggle-hover">Our Work</a></li>
                <li class="on-demand-develop padding-right-15"><a href="aboutus.php" class="dropdown-toggle-hover">About us</a></li>
                    <li class="on-demand-develop contact-us-button margin-right-20"><a href="contactus.php" class="text-center" id="contact-us-url"><span>Contact Us</span></a></li>
                </ul>
            </div>
        </div>
    </nav>
