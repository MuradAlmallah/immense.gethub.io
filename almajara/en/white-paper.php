...
<head>
    ...
    <title>White Paper | Almajara</title>
        ...
        <section class="sorting jplist-panel md-margin-top-160 background-light-grey">
            <div class="container">
                <div class="text-center">
                    <h1 class="case-study-hero">White Papers</h1>
                        ...
                        <div class="row">
                            <div class="col-xs-12 no-padding">
                                <ul class="nav nav-tabs news-tab">
                                    ...
                                    <li class="text-uppercase active"><a href="white-paper.php"> WHITE PAPERS</a></li>
                                </ul>
                            </div>
                                ...
                                <div class="row list">
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 list-item margin-top-15">
                                        <div class="cs-grid-item list-item Gaming MySQL Database Mongo Database Visual Studio Blockchain Crypto wallet"><a href="https://www.chetu.com/white-paper/transforming-human-experience-with-blockchain-metaverse.php">
                                                <div class="paper-box pb-v3">
                                                    <div class="papper-heading">Gaming</div>
                                                    ...
                                                    <div class="white-details">
                                                        <p class="cs_sub_text"><span class="txt-white"> White Paper:</span> Blockchain Metaverse Transforms Human Experience</p>
                                                    </div>
                                                </div>
                                            </a></div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 list-item margin-top-15">
                                        <div class="cs-grid-item list-item Hospitality & Travel PHP MySQL Microsoft Windows Apache Visual Studio Code"><a href="https://www.chetu.com/white-paper/contactless-tipping-app.php">
                                                <div class="paper-box pb-v3">
                                                    <div class="papper-heading"> Hospitality & Travel </div>
                                                    <div class="slater_block">
                                                    ...
                                                    <div class="white-details">
                                                        <p class="cs_sub_text"><span class="txt-white"> White Paper:</span> Contactless Tipping App Revolutionizes Employee Engagement</p>
                                                    </div>
                                                </div>
                                            </a></div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 list-item margin-top-15">
                                        <div class="cs-grid-item list-item E-Learning-Education Java"><a href="https://www.chetu.com/white-paper/insurance-robotic-process-automation.php">
                                                <div class="paper-box pb-v3">
                                                    <div class="papper-heading"> Insurance </div>
                                                    <div class="slater_block">
                                                    ...
                                                    <div class="white-details">
                                                        <p class="cs_sub_text"><span class="txt-white"> White Paper:</span> Chetu Modernizes Insurance Claims Process with Robotic Process Automation </p>
                                                    </div>
                                                </div>
                                            </a></div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 list-item margin-top-15">
                                        <div class="cs-grid-item list-item Retail Java"><a href="https://www.chetu.com/white-paper/secure-web-app-development-for-gaming-retailer.php">
                                                <div class="paper-box pb-v3">
                                                    <div class="papper-heading"> Retail</div>
                                                    <div class="slater_block">
                                                    ...
                                                    <div class="white-details">
                                                        <p class="cs_sub_text"><span class="txt-white"> White Paper:</span> Chetu Develops Secure Web App for Global Gaming Retailer </p>
                                                    </div>
                                                </div>
                                            </a></div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 list-item margin-top-15">
                                        <div class="cs-grid-item list-item Environmental-Management Ruby-on-Rails SQL-Server GIT"><a href="https://www.chetu.com/case-study/esri-arcgis-developers-augment-app.php">
                                                <div class="paper-box pb-v3">
                                                    <div class="papper-heading">Environmental Management</div>
                                                    <div class="slater_block">
                                                    ...
                                                    <div class="white-details">
                                                        <p class="cs_sub_text"><span class="txt-white"> White Paper:</span> ESRI Arcgis APP Development Advances Topographical Competitive Edge in Local Communities </p>
                                                    </div>
                                                </div>
                                            </a></div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 list-item margin-top-15">
                                        <div class="cs-grid-item list-item E-Learning-Educatio PHP SQL-Server WordPress"><a href="https://www.chetu.com/case-study/fintech-platform-disrupts-the-indusry.php">
                                                <div class="paper-box pb-v3">
                                                    <div class="papper-heading">Finance</div>
                                                    <div class="slater_block">
                                                    ...
                                                    <div class="white-details">
                                                        <p class="cs_sub_text"><span class="txt-white"> White Paper:</span> Fintech Platform Disrupts Financial Service Industry with Single Sign-on Integration </p>
                                                    </div>
                                                </div>
                                            </a></div>
                                    </div>
