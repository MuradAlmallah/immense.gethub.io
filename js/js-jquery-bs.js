  ...
  +(function (t) {
    ...
    function e(e) {
      return this.each(function () {
        ...
        n || s.data("bs.carousel", (n = new i(this, a))),
          "number" == typeof e
            ? n.to(e)
            : r
            ? n[r]()
            : a.interval && n.pause().cycle();
      });
    }
    var i = function (e, i) {
      (this.$element = t(e)),
  ...
  +(function (t) {
        ...
        t(a).each(function () {
          ...
          n.hasClass("open") &&
            ((i &&
              ...
              (n.trigger((i = t.Event("hide.bs.dropdown", a))),
      ...
      (r.prototype.toggle = function (s) {
        ...
        if (!n.is(".disabled, :disabled")) {
          ...
          if ((i(), !r)) {
            ...
            if (
              (a.trigger((s = t.Event("show.bs.dropdown", o))),
              s.isDefaultPrevented())
            )
              return;
            n.trigger("focus").attr("aria-expanded", "true"),
              a.toggleClass("open").trigger(t.Event("shown.bs.dropdown", o));
          }
          return !1;
        }
      }),
        ...
        if (
          ...
          if (
            ...
            if ((!r && 27 != i.which) || (r && 27 == i.which))
              return (
                27 == i.which && n.find(a).trigger("focus"), s.trigger("click")
              );
    ...
    (t.fn.dropdown = s),
      ...
      t(document)
        ...
        .on("click.bs.dropdown.data-api", a, r.prototype.toggle)
        .on("keydown.bs.dropdown.data-api", a, r.prototype.keydown)
        .on(
    ...
    (e.VERSION = "3.3.7"),
          ...
          this.$body
            ...
            .map(function () {
              var e = t(this),
                ...
                a = /^#./.test(n) && t(n);
              return (
                (a && a.length && a.is(":visible") && [[a[i]().top + s, n]]) ||
                null
              );
            })
            .sort(function (t, e) {
      ...
      (e.prototype.process = function () {
        ...
        if ((this.scrollHeight != i && this.refresh(), e >= s))
          return r != (t = a[a.length - 1]) && this.activate(t);
